...
(3, 'ร้านค้าทั่วไปหน้าเรือนจํา', 1),
(4, 'บริเวณแนวรอบรั้วกําแพงรอบเรือนจํา/ทัณฑสถาน', 1),
(5, 'บ้านพักข้าราชการเรือนจํา/ทัณฑสถาน', 1),
(6, 'ประตูเรือนจํา/ทัณฑสถาน', 1),
(7, 'ท่อระบายน้ํารอบเรือนจํา/ทัณฑสถาน', 1),
(8, 'ตู้จดหมายเรือนจํา/ทัณฑสถาน', 1),
(9, 'ตะกร้าเสื้อผ้า', 1),
(10, 'เจ้าหน้าที่เรือนจำ/ทัณฑสถาน', 1),
(11, 'เขตควบคุมพิเศษ', 2),
(12, 'แดนแรกรับผู้ต้องขังเข้าใหม่', 2),
(13, 'แดนประหาร', 2),
...
CREATE TABLE IF NOT EXISTS `report` (
  ...
  `special_method_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `special_method`
--

CREATE TABLE IF NOT EXISTS `special_method` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `special_method`
--

INSERT INTO `special_method` (`id`, `name`) VALUES
(1, 'โดยมีหน่วยภาคีสนธิกำลัง'),
(2, 'โดยชุด ปพ. และ/หรือ ศปส. กรมราชทัณฑ์');
